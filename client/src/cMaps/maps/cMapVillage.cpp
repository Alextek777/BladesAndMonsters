...
bool cMap_Village::PopulateDynamics(vector<cDynamic*> &vecDyns) {
    ...
    vecDyns.push_back(new cDynamic_cloud("cloud", 100, 140));
	vecDyns.push_back(new cDynamic_cloud("cloud", 130, 170));
	vecDyns.push_back(new cDynamic_cloud("cloud", 170, 100));
	vecDyns.push_back(new cDynamic_cloud("cloud", 50, 70));
	vecDyns.push_back(new cDynamic_cloud("cloud", 150, 210));
