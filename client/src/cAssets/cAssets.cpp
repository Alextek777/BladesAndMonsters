...
void Assets::LoadAnimations() {
	...
	m_animationHandler.load("witty", e_GraphicsState::WALKING, e_FactionDirection::WEST, 8, 100, "animations/witty/walking/west.png");
	m_animationHandler.load("witty", e_GraphicsState::WALKING, e_FactionDirection::NORTH, 8, 100, "animations/witty/walking/east.png");
	m_animationHandler.load("witty", e_GraphicsState::WALKING, e_FactionDirection::SOUTH, 8, 100, "animations/witty/walking/west.png");

	m_animationHandler.load("witty", e_GraphicsState::STANDING, e_FactionDirection::EAST, 6, 100, "animations/witty/standing/east.png");
	m_animationHandler.load("witty", e_GraphicsState::STANDING, e_FactionDirection::WEST, 6, 100, "animations/witty/standing/west.png");
